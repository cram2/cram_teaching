...
;; TODO (optional) Embed the move method in a closure. Within this closure, increment a local variable
;;      for each successful move made. No defparameter, defvar etc. allowed, the variable
;;      must not be visible from the outside.
;; TODO (optional) Within the closure, alongside the move method, define a function that returns the
